...
func (uc *roleUseCase) checkRoleExists(id string, ctx *gin.Context) (*dtos.RoleResponse, *models.ErrorResponse) {
...
func (uc *roleUseCase) GetAllRoles(ctx *gin.Context) ([]*dtos.RoleResponse, *models.ErrorResponse) {
	return uc.roleRepository.GetAllRoles(ctx)
}

func (uc *roleUseCase) GetRoleById(id string, ctx *gin.Context) (*dtos.RoleResponse, *models.ErrorResponse) {
	return uc.checkRoleExists(id, ctx)
}

func (uc *roleUseCase) CreateRole(role dtos.RoleCreateRequest, ctx *gin.Context) (*dtos.RoleResponse, *models.ErrorResponse) {
...
func (uc *roleUseCase) UpdateRole(id string, role dtos.RoleUpdateRequest, ctx *gin.Context) (*dtos.RoleResponse, *models.ErrorResponse) {
...
func (uc *roleUseCase) DeleteRole(id string, ctx *gin.Context) *models.ErrorResponse {
...
func (uc *roleUseCase) GetRoleUsers(id string, ctx *gin.Context) ([]*dtos.UserResponse, *models.ErrorResponse) {
